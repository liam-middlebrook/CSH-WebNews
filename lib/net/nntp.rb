# WEBNEWS AUTHOR'S NOTE:
# This is a fork of the original Net::NNTP library that adds Ruby 1.9
# support, created by "kinnou02". See https://github.com/kinnou02/nntp-lib
# for full source.
#
# = net/nntp.rb
#
